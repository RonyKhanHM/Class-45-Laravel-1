          ...
          <div class="col-md-3">
              <div class="filter-items-wrapper">
                  ...
                  <div class="filter-items-outer">
                      ...
                      <form class="filter-items" id="collapseOne" action="{{url('/combo-products')}}" method="GET">
                        @csrf                                    
                  ...
                  <div class="filter-items-outer">
                      ...
                      <form class="filter-items" id="collapseTwo" action="{{url('/combo-products')}}" method="GET">
                        @csrf
