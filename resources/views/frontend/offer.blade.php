          ...
          <div class="col-md-3">
              <div class="filter-items-wrapper">
                  ...
                  <div class="filter-items-outer">
                      ...
                      <form class="filter-items" id="collapseOne" action="{{url('/offer-products')}}" method="GET">
                        @csrf                                    
                  ...
                  <div class="filter-items-outer">
                      ...
                      <form class="filter-items" id="collapseTwo" action="{{url('/offer-products')}}" method="GET">
                        @csrf
