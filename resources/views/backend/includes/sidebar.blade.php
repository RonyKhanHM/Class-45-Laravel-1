              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  @if (Auth::user()->role == 'admin')
                      ...
                      <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                              <li class="nav-item">
                                  <a href="{{ url('/admin/show-vendor') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>List</p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="{{ url('/admin/added-vendor') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Add New</p>
                                  </a>
                              </li>
                      ...
                      <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                              <li class="nav-item">
                                  <a href="{{ url('/admin/show-sliders') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>List</p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="{{ url('/admin/create-sliders') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Add New</p>
                                  </a>
                              </li>
