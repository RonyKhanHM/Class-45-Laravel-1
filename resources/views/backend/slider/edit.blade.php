...
@section('content')
    <div class="container-fluid">
        <!-- SELECT2 EXAMPLE -->
        <form action="{{ url('/admin/update-sliders/'. $slider->id) }}" method="POST" enctype="multipart/form-data"
            class="form-control">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="description" value="{{ $slider->description }}" class="form-control"
                                    required placeholder="Enter Slider Description*">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('backend/images/sliderBanner/' . $slider->image) }}" height="100"
                                    width="100">
                            </div>
                        </div>
                        <div class="col-md-12">
